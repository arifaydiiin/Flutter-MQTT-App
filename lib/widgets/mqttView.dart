...
import 'package:flutter_mqtt2/mqtt/MQTTManager.dart';
...
class _MQTTViewState extends State<MQTTView> {
  ...
  late String androidmodel;

 Future<String> deviceinfogetir()async{
...
return androidInfo.model.toString();
  ...
  Widget build(BuildContext context) {
    ...
    final Scaffold scaffold = Scaffold(body: SafeArea(child: SingleChildScrollView(child: _buildColumn())));
    return scaffold;
  }
  ...
  void _publishMessage(String text)async {

    final String message = androidmodel+ ' says: ' + text;
